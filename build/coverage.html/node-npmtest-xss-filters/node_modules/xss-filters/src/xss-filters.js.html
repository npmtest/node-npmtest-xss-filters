...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-xss-filters/node_modules/xss-filters/src/xss-filters.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-xss-filters">npmtest-xss-filters (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-xss-filters/node_modules/xss-filters/src/xss-filters.js</span></h1>
    <h2>
        
        Statements: <span class="metric">42.2% <small>(46 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">0.59% <small>(1 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">2.04% <small>(1 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">42.59% <small>(46 / 108)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-xss-filters/node_modules/xss-filters/src/</a> &#187; xss-filters.js</div>
</div>
<div class="body">
...
1099
1100
1101</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    var x, 
        strReplace = <span class="fstat-no" title="function not covered" >function (s, regexp, callback) {</span>
<span class="cstat-no" title="statement not covered" >            return s === undefined ? 'undefined'</span>
                    : s === null            ? 'null'
                    : s.toString().replace(regexp, callback);
        },
        fromCodePoint = String.fromCodePoint || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function(codePoint) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            return String.fromCharCode((codePoint &gt;&gt; 10) + 0xD800, (codePoint % 0x400) + 0xDC00);</span>
        };
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >    function getProtocol(str) {</span>
<span class="cstat-no" title="statement not covered" >        var s = str.split(URI_PROTOCOL_COLON, 2);</span>
        // str.length !== s[0].length is for older IE (e.g., v8), where delimeter residing at last will result in length equals 1, but not 2
<span class="cstat-no" title="statement not covered" >        return (s[0] &amp;&amp; (s.length === 2 || str.length !== s[0].length)) ? s[0] : null;</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function htmlDecode(s, namedRefMap, reNamedRef, skipReplacement) {</span>
        
<span class="cstat-no" title="statement not covered" >        namedRefMap = namedRefMap || SENSITIVE_NAMED_REF_MAP;</span>
<span class="cstat-no" title="statement not covered" >        reNamedRef = reNamedRef || SENSITIVE_HTML_ENTITIES;</span>
&nbsp;
<span class="fstat-no" title="function not covered" >        function regExpFunction(m, num, named, named1) {</span>
<span class="cstat-no" title="statement not covered" >            if (num) {</span>
<span class="cstat-no" title="statement not covered" >                num = Number(num[0] &lt;= '9' ? num : '0' + num);</span>
                // switch(num) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                return skipReplacement ? fromCodePoint(num)</span>
                        : num === 0x80 ? '\u20AC'  // EURO SIGN (€)
...
<span class="cstat-no" title="statement not covered" >            return namedRefMap[named || named1] || m;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return s === undefined  ? 'undefined'</span>
            : s === null        ? 'null'
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function cssEncode(chr) {</span>
        // space after \\HEX is needed by spec
<span class="cstat-no" title="statement not covered" >        return '\\' + chr.charCodeAt(0).toString(16).toLowerCase() + ' ';</span>
    }
<span class="fstat-no" title="function not covered" >    function cssBlacklist(s) {</span>
<span class="cstat-no" title="statement not covered" >        return s.replace(CSS_BLACKLIST, <span class="fstat-no" title="function not covered" >function(m){</span> <span class="cstat-no" title="statement not covered" >return '-x-' + m; </span>});</span>
    }
<span class="fstat-no" title="function not covered" >    function cssUrl(s) {</span>
        // encodeURI() in yufull() will throw error for use of the CSS_UNSUPPORTED_CODE_POINT (i.e., [\uD800-\uDFFF])
<span class="cstat-no" title="statement not covered" >        s = x.yufull(htmlDecode(s));</span>
<span class="cstat-no" title="statement not covered" >        var protocol = getProtocol(s);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return (protocol &amp;&amp; URI_BLACKLIST_PROTOCOLS[protocol.toLowerCase()]) ? '##' + s : s;</span>
    }
&nbsp;
    return (x = {
        // turn invalid codePoints and that of non-characters to \uFFFD, and then fromCodePoint()
        frCoPt: <span class="fstat-no" title="function not covered" >function(num) {</span>
<span class="cstat-no" title="statement not covered" >            return num === undefined || num === null ? '' :</span>
...
&nbsp;
         ...
         */
        yup: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            s = getProtocol(s.replace(NULL, ''));</span>
            // URI_PROTOCOL_WHITESPACES is required for left trim and remove interim whitespaces
<span class="cstat-no" title="statement not covered" >            return s ? htmlDecode(s, URI_PROTOCOL_NAMED_REF_MAP, null, true).replace(URI_PROTOCOL_WHITESPACES, '').toLowerCase() : null;</span>
        },
&nbsp;
        /*
         * @deprecated
         ...
         *
         */
        y: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, SPECIAL_HTML_CHARS, <span class="fstat-no" title="function not covered" >function (m) {</span></span>
...
&nbsp;
        ...
        ya: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, AMP, '&amp;amp;');</span>
        },
&nbsp;
        // FOR DETAILS, refer to inHTMLData()
        // Reference: https://html.spec.whatwg.org/multipage/syntax.html#data-state
        yd: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, LT, '&amp;lt;');</span>
        },
&nbsp;
        ...
        yc: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, SPECIAL_COMMENT_CHARS, <span class="fstat-no" title="function not covered" >function(m){</span></span>
<span class="cstat-no" title="statement not covered" >                return m === '\x00' ? '\uFFFD'</span>
                    : m === '--!' || m === '--' || m === '-' || m === ']' ? m + ' '
                    :/*
                    :  m === ']&gt;'   ? '] &gt;'
                    :  m === '--&gt;'  ? '-- &gt;'
...
&nbsp;
        ...
        yavd: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, QUOT, '&amp;quot;');</span>
        },
&nbsp;
        ...
        yavs: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, SQUOT, '&amp;#39;');</span>
        },
&nbsp;
        ...
        yavu: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return strReplace(s, SPECIAL_ATTR_VALUE_UNQUOTED_CHARS, <span class="fstat-no" title="function not covered" >function (m) {</span></span>
<span class="cstat-no" title="statement not covered" >                return m === '\t'   ? '&amp;#9;'  // in hex: 09</span>
                    :  m === '\n'   ? '&amp;#10;' // in hex: 0A
...
&nbsp;
        ...
        yubl: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return URI_BLACKLIST_PROTOCOLS[x.yup(s)] ? 'x-' + s : s;</span>
        },
&nbsp;
        // This is NOT a security-critical filter.
        // Reference: https://tools.ietf.org/html/rfc3986
        yufull: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return x.yu(s).replace(URL_IPV6, <span class="fstat-no" title="function not covered" >function(m, p) {</span></span>
<span class="cstat-no" title="statement not covered" >                return '//[' + p + ']';</span>
            });
        },
&nbsp;
        // chain yufull() with yubl()
        yublf: <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >            return x.yubl(x.yufull(s));</span>
        },
&nbsp;
...
&nbsp;
        yceu: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            s = htmlDecode(s);</span>
<span class="cstat-no" title="statement not covered" >            return CSS_VALID_VALUE.test(s) ? s : ";-x:'" + cssBlacklist(s.replace(CSS_SINGLE_QUOTED_CHARS, cssEncode)) + "';-v:";</span>
        },
&nbsp;
        // string1 = \"([^\n\r\f\\"]|\\{nl}|\\[^\n\r\f0-9a-f]|\\[0-9a-f]{1,6}(\r\n|[ \n\r\t\f])?)*\"
        yced: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            return cssBlacklist(htmlDecode(s).replace(CSS_DOUBLE_QUOTED_CHARS, cssEncode));</span>
        },
&nbsp;
        // string2 = \'([^\n\r\f\\']|\\{nl}|\\[^\n\r\f0-9a-f]|\\[0-9a-f]{1,6}(\r\n|[ \n\r\t\f])?)*\'
        yces: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            return cssBlacklist(htmlDecode(s).replace(CSS_SINGLE_QUOTED_CHARS, cssEncode));</span>
        },
&nbsp;
        // for url({{{yceuu url}}}
        ...
        // CSS_UNQUOTED_URL = /['\(\)]/g; // " \ treated by encodeURI()   
        yceuu: <span class="fstat-no" title="function not covered" >function(s) {</span>
<span class="cstat-no" title="statement not covered" >            return cssUrl(s).replace(CSS_UNQUOTED_URL, <span class="fstat-no" title="function not covered" >function (chr) {</span></span>
<span class="cstat-no" title="statement not covered" >                return  chr === '\''        ? '\\27 ' :</span>
                        chr === '('         ? '%28' :
                        /* chr === ')' ? */   '%29';
            });
        },
&nbsp;
        // for url("{{{yceud url}}}
        yceud: <span class="fstat-no" title="function not covered" >function(s) { </span>
<span class="cstat-no" title="statement not covered" >            return cssUrl(s);</span>
        },
&nbsp;
        // for url('{{{yceus url}}}
        yceus: <span class="fstat-no" title="function not covered" >function(s) { </span>
<span class="cstat-no" title="statement not covered" >            return cssUrl(s).replace(SQUOT, '\\27 ');</span>
        }
    });
};
&nbsp;
...
<span class="fstat-no" title="function not covered" >function uriInAttr (s, yav, yu) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yubl(yav((yu || privFilters.yufull)(s)));</span>
}
&nbsp;
/** 
...
* 
*/
exports.uriInSingleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return uriInAttr(s, privFilters.yavs);</span>
};
&nbsp;
/**
...
* 
*/
exports.uriInDoubleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return uriInAttr(s, privFilters.yavd);</span>
};
&nbsp;
&nbsp;
/**
...
* 
*/
exports.uriInUnQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return uriInAttr(s, privFilters.yavu);</span>
};
&nbsp;
/**
...
* 
*/
exports.uriInHTMLComment = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yc(privFilters.yufull(s));</span>
};
&nbsp;
&nbsp;
&nbsp;
...
* 
*/
exports.uriPathInSingleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return uriInAttr(s, privFilters.yavs, privFilters.yu);</span>
};
&nbsp;
/**
...
* 
*/
exports.uriPathInDoubleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return uriInAttr(s, privFilters.yavd, privFilters.yu);</span>
};
&nbsp;
&nbsp;
/**
...
* 
*/
exports.uriPathInUnQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return uriInAttr(s, privFilters.yavu, privFilters.yu);</span>
};
&nbsp;
/**
...
*/
exports.uriPathInHTMLComment = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yc(privFilters.yu(s));</span>
};
&nbsp;
&nbsp;
/**
...
* 
*/
exports.uriComponentInSingleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yavs(privFilters.yuc(s));</span>
};
&nbsp;
/**
...
* 
*/
exports.uriComponentInDoubleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yavd(privFilters.yuc(s));</span>
};
&nbsp;
&nbsp;
/**
...
* 
*/
exports.uriComponentInUnQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yavu(privFilters.yuc(s));</span>
};
&nbsp;
/**
...
*/
exports.uriComponentInHTMLComment = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yc(privFilters.yuc(s));</span>
};
&nbsp;
&nbsp;
...
* 
*/
exports.uriFragmentInSingleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yubl(privFilters.yavs(privFilters.yuc(s)));</span>
};
&nbsp;
...
* 
*/
exports.uriFragmentInDoubleQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yubl(privFilters.yavd(privFilters.yuc(s)));</span>
};
&nbsp;
...
* 
*/
exports.uriFragmentInUnQuotedAttr = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >    return privFilters.yubl(privFilters.yavu(privFilters.yuc(s)));</span>
};
&nbsp;
&nbsp;
/**
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 11:17:58 GMT+0000 (UTC)</div>
</div>
</body>
</html>
